  ...
  <img id="collage" src="images/Header-Banner_Homepage-Collage.png" width="1024" height="150" alt=Photo Collage" />
    ...
    <div id="mainNav">
      <ul id="menuSample">
        ...
        <li><a href="" class="drop">Fundraising<br>Examples</a></li>
      <div class="dropdown_4columns"> <!-- Begin 4 columns Item -->
        <div class="col_1"> <!-- Begin 4 columns container -->
          <h3><a class="lead" href="">High School</a></h3>
          <h3><a class="subHead" href="">Clubs &amp; Organizations</a></h3>
          <ul>
            <li><a href="http://test.greatmoods.com/salesTest/samplewebsites/sample_band_website.php">Band</a></li>
            <li><a href="#">BPA</a></li>
        ...
        <div class="col_1">
          ...
          <ul>
            ...
            <li><a href="#">Tennis, Girls</a></li>
            <li><a href="#">Track &amp; Field</a></li>
            <li><a href="#">Volleyball, Boys</a></li>
            <li><a href="#">Volleyball, Girls</a></li>
      ...
      <!-- End 4 columns Item -->
        ...
        <li><a href="setupEditWebsite/fundtype.php" id="gone">Setup/Edit<br>Website</a></li>
    	<li><a href="" id="gone">Setup/Edit<br>Members</a></li>
    	<li><a href="" id="gone">Setup/Edit<br>Emails</a></li>
